...
b1=banner1.new(rect.new(10,3,40,15), " 2 3 רפסמ רנאב  test in hebrew  ",1,1,0)
b2=banner2.new(rect.new(20,3,40,15), " 2 3 רפסמ רנאב  test in hebrew  ",1,3,500,500,1)
	b1:render(0);
